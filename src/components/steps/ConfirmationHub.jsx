  ...
  return (
    <div className="max-w-2xl mx-auto px-6 pb-24 pt-10">
      ...
      <div className="mb-12 animate-fade-up">
        ...
        <h1 className="text-[52px] sm:text-[64px] font-bold text-[#1d1d1f] leading-[1.04] mb-4" style={{ letterSpacing: '-0.03em' }}>
          You're<br />
          <span className="text-[#007a5a]">settled.</span>
        </h1>
        <p className="text-[17px] text-[#6e6e73] leading-relaxed">Loan is active. The dealer has been paid directly.</p>
      </div>

      {/* Loan terms card */}
      <div className="bg-white rounded-2xl shadow-sm overflow-hidden mb-6 animate-fade-up delay-100">
        <div className="px-6 py-5 border-b border-[rgba(0,0,0,0.06)] bg-[#f5f5f7]">
        ...
        <div className="grid grid-cols-3 px-6 py-5 bg-[#f5f5f7]">
      ...
      {/* Repayment schedule */}
      <div className="bg-white rounded-2xl shadow-sm overflow-hidden mb-6 animate-fade-up delay-200">
        <div className="px-6 py-4 border-b border-[rgba(0,0,0,0.06)] bg-[#f5f5f7]">
          <p className="text-[10px] font-bold uppercase tracking-widest text-[#86868b]">Repayment schedule — first 6 months</p>
        </div>
        <div className="grid grid-cols-4 px-6 py-3 border-b border-[rgba(0,0,0,0.06)]">
        ...
        {Array.from({ length: 6 }, (_, i) => {
          ...
          return (
            <div key={i} className="grid grid-cols-4 px-6 py-3 text-xs border-b border-[rgba(0,0,0,0.04)] last:border-0">
      ...
      {/* Audit trail */}
      <div className="bg-white rounded-2xl shadow-sm overflow-hidden mb-6 animate-fade-up delay-300">
        <div className="px-6 py-4 border-b border-[rgba(0,0,0,0.06)] bg-[#f5f5f7]">
            ...
            {[...activityLog].reverse().map((entry) => (
              <div key={entry.id} className="flex gap-4 pb-5 last:pb-0">
                <div className="w-4 h-4 rounded-full shrink-0 mt-0.5 z-10 border"
                  style={{
                    background: entry.actor === 'System' ? '#eef7f3' : entry.actor === 'Financier' ? '#f5f5f7' : '#f5f5f7',
      ...
      {/* What happens next */}
      <div className="bg-white rounded-2xl shadow-sm overflow-hidden mb-6 animate-fade-up delay-400">
        <div className="px-6 py-4 border-b border-[rgba(0,0,0,0.06)] bg-[#f5f5f7]">
      ...
      {/* Important contacts */}
      <div className="bg-white rounded-2xl shadow-sm overflow-hidden mb-10 animate-fade-up delay-500">
        <div className="px-6 py-4 border-b border-[rgba(0,0,0,0.06)] bg-[#f5f5f7]">
        ...
        <div className="p-6 flex flex-col gap-5">
          ...
          <div className="border-t border-[rgba(0,0,0,0.06)] pt-5">
            ...
            <p className="text-sm text-[#6e6e73] leading-relaxed">
              ...
              <span className="text-[#1d1d1f] font-medium">afca.org.au · 1800 931 678</span> — free to use, no legal representation needed.
            </p>
          </div>
        </div>
      </div>
